export const profile = {
  ...
  about:
    "AI/ML engineer and researcher working across Natural Language Processing, Large Language Models, Generative AI, and Computer Vision. First author of two published research papers, including an IEEE Best Paper Award-winning study on legal-document NLP, alongside hands-on experience building transformer, LLM, and deep learning systems end-to-end \u2014 from architecture and training to deployment.",
};
...
export const conferencePresentation = {
  ...
  status: "Co-Author \u00b7 Oral Research Presentation (not published)",
